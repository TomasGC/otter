...
@HiltAndroidTest
class E2ETarGzWorkflowInstrumentedTest : E2EArchiveWorkflowInstrumentedTest() {

    @Inject
    lateinit var tarExtractor: TarExtractor

    override val archiveType: ArchiveType = ArchiveType.TAR_GZ
    override val testArchivePath: String = ArchiveNavigationTestHelper.getArchivePath(
        ArchiveNavigationTestHelper.TEST_ARCHIVE_TAR_GZ
    )
    override val extractor: ArchiveExtractor get() = tarExtractor
    override val archiveExtension: String = ".tar.gz"
}
