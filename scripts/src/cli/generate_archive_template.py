...
FILE_TYPES = [
    (".txt", 25), (".csv", 15), (".pdf", 10), (".jpg", 15),
    (".png", 10), (".gif", 5), (".webp", 5), (".webm", 10), (".mp4", 5),
]
...
_WEBP_BYTES = bytes([
    ...
    0x00, 0x00, 0x41, 0x9C, 0x01, 0x4A, 0x00, 0x9D,
])
_MP4_BYTES = bytes([
...
_BINARY_CONTENT: dict[str, bytes] = {
    ".pdf": _PDF_BYTES, ".jpg": _JPG_BYTES, ".jpeg": _JPG_BYTES,
    ".png": _PNG_BYTES, ".gif": _GIF_BYTES, ".webp": _WEBP_BYTES,
    ".mp4": _MP4_BYTES, ".webm": _WEBM_BYTES,
}
...
class ArchiveTemplateGenerator:
    ...
    DEFAULT_STRUCTURE = [
        ("folder_30", 30), ("folder_80", 80), ("folder_300", 300),
        ("folder_500", 500), ("folder_1000", 1000), ("folder_2000", 2000),
    ]
    ROOT_COUNT = 100
    ...
    def make_txt_content(rng: _random.Random) -> str:
        ...
        return "\n".join(
            [f"Line {i} with random data: {rng.randint(1000, 9999)}" for i in range(lines)]
        )
